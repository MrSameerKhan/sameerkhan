...
Example (small corpus):
  ...
  Initial: l o w _ l o w _ l o w _ l o w e r _ l o w e r _ n e w e s t _ n e w e s t _
...
# [101, 4895, 18137, 15313, 3251, 3435, 102]
...
# [9906, 11, 4435, 0, 11410, 234, 235]  (7 tokens)
...
"hidden_size" → ['hidden', '_size']     # 2 tokens
"HIDDEN_SIZE" → ['H', 'IDD', 'EN', '_S', 'IZE']  # 5 tokens (less efficient)
```
...
**Long documents → chunking required.** BERT has 512-token max. For long texts, chunk with overlap (stride=64 tokens) and aggregate chunk results.
...
| Token count budgeting in agents | `6.llms/09_agents_end_to_end.md` |

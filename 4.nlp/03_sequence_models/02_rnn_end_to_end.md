...
Loss:
  ...
  If ŷ=0.329 and y=1.0: L = ½(0.671)² = 0.225   ← model is wrong
...
a₁ = [0.600 + 0.000, 0.400 + 0.000] = [0.600, 0.400]
h₁ = tanh([0.600, 0.400]) = [0.537, 0.380]
```

**h₁ = [0.537, 0.380]** ← "cat" is encoded here at full strength
...
Wh · h₁ (h₁ = [0.537, 0.380]):
  row 0: 0.4×0.537 + 0.1×0.380 = 0.215 + 0.038 = 0.253
  row 1: 0.2×0.537 + 0.3×0.380 = 0.107 + 0.114 = 0.221

a₂ = [0.160 + 0.253, 0.200 + 0.221] = [0.413, 0.421]
h₂ = tanh([0.413, 0.421]) = [0.391, 0.398]
```

**h₂ = [0.391, 0.398]** ↑ compare h₁[0]=0.537 → now 0.391: "cat" signal already diluted by "sat"
...
Wh · h₂ (h₂ = [0.391, 0.398]):
  row 0: 0.4×0.391 + 0.1×0.398 = 0.156 + 0.040 = 0.196
  row 1: 0.2×0.391 + 0.3×0.398 = 0.078 + 0.119 = 0.198

a₃ = [0.070 + 0.196, 0.070 + 0.198] = [0.266, 0.268]
h₃ = tanh([0.266, 0.268]) = [0.260, 0.261]
```

**h₃ = [0.260, 0.261]** ↑ was 0.537 at h₁ → now 0.260: dropped by more than half after just 2 more words
...
Wh · h₃ (h₃ = [0.260, 0.261]):
  row 0: 0.4×0.260 + 0.1×0.261 = 0.104 + 0.026 = 0.130
  row 1: 0.2×0.260 + 0.3×0.261 = 0.052 + 0.078 = 0.130

a₄ = [0.180 + 0.130, 0.260 + 0.130] = [0.310, 0.390]
h₄ = tanh([0.310, 0.390]) = [0.301, 0.372]
```

**h₄ = [0.301, 0.372]** ← final hidden state (what the whole sentence "compressed" into)

### Output layer

```
ŷ = Wy · h₄ = 0.6×0.301 + 0.4×0.372 = 0.181 + 0.149 = 0.329
```

(Using the rounded h₄ = [0.301, 0.372] throughout gives ŷ = 0.329)

### Forward pass summary

|  | dim 0 (animal-related) | dim 1 (content) |
|---|---|---|
| h₁ = [0.537, 0.380] | after "cat": strong animal signal, clear content |
| h₂ = [0.391, 0.398] | after "sat": animal signal fading, content mixed in |
| h₃ = [0.260, 0.261] | after "on":  animal signal weak, content dropped too |
| h₄ = [0.301, 0.372] | after "mat": animal signal faint, content from mat added |

```
dim 0 across steps: 0.537 → 0.391 → 0.260 → 0.301
↑ each step blends in the new word and dilutes what came before
h₄[dim 0] = 0.301 is NOT "cat" preserved at 56%
it is a blend of cat + sat + on + mat
cat just happened to dominate dim 0 initially

ŷ = 0.329   (model says "probably not animal" — cat's signal too diluted)
...
```
L = ½ (y - ŷ)² = ½ (1.000 - 0.329)² = ½ × 0.671² = ½ × 0.450 = 0.225

Error = 0.671.  The model forgot too much of "cat" to predict confidently.
```
...
∂L/∂Wy = ∂L/∂ŷ × h₄ᵀ = -0.671 × [0.301, 0.372] = [-0.202, -0.250]
                                                      (1×2 matrix gradient)

∂L/∂h₄ = ∂L/∂ŷ × Wyᵀ = -0.671 × [0.6, 0.4]ᵀ = [-0.403, -0.268]
                                                   (2D vector — error signal entering BPTT)

Define δ₄ = ∂L/∂h₄  (the error vector at each hidden state).

δ₄ = [-0.403, -0.268]   ← full error signal
```
...
δ₃ = Whᵀ · ∂L/∂a₄:
  row 0: 0.4×(-0.366) + 0.2×(-0.231) = -0.146 + (-0.046) = -0.193
  row 1: 0.1×(-0.366) + 0.3×(-0.231) = -0.037 + (-0.069) = -0.106
...
∂L/∂a₃ = δ₃ ⊙ (1-h₃²)
        = [-0.193×0.932,  -0.106×0.932]
        = [-0.180,        -0.099]

δ₂ = Whᵀ · ∂L/∂a₃:
  row 0: 0.4×(-0.180) + 0.2×(-0.099) = -0.072 + (-0.020) = -0.092
  row 1: 0.1×(-0.180) + 0.3×(-0.099) = -0.018 + (-0.030) = -0.048
...
∂L/∂a₂ = δ₂ ⊙ (1-h₂²)
        = [-0.092×0.847,  -0.048×0.842]
        = [-0.078,        -0.040]

δ₁ = Whᵀ · ∂L/∂a₂:
  row 0: 0.4×(-0.078) + 0.2×(-0.040) = -0.031 + (-0.008) = -0.039
  row 1: 0.1×(-0.078) + 0.3×(-0.040) = -0.008 + (-0.012) = -0.020
...
|δ₄| = √(0.403² + 0.268²) = √(0.162 + 0.072) = √0.234 = 0.484   ← full error
|δ₃| = √(0.193² + 0.106²) = √(0.037 + 0.011) = √0.048 = 0.220   ← 45% left
|δ₂| = √(0.092² + 0.048²) = √(0.008 + 0.002) = √0.011 = 0.103   ← 21% left
|δ₁| = √(0.039² + 0.020²) = √(0.002 + 0.000) = √0.002 = 0.044   ← 9% left
...
```
t=1: [-0.028, -0.017]ᵀ ⊗ [1.00, 0.50]:
  [[-0.028×1.00, -0.028×0.50], [-0.017×1.00, -0.017×0.50]]
  = [[-0.028, -0.014], [-0.017, -0.008]]

t=2: [-0.078, -0.040]ᵀ ⊗ [0.20, 0.30]:
  [[-0.016, -0.023], [-0.008, -0.012]]

t=3: [-0.180, -0.099]ᵀ ⊗ [0.10, 0.10]:
  [[-0.018, -0.018], [-0.010, -0.010]]

t=4: [-0.366, -0.231]ᵀ ⊗ [0.20, 0.40]:
  [[-0.073, -0.146], [-0.046, -0.092]]

Sum (∂L/∂Wx):
  [[-0.028 - 0.016 - 0.018 - 0.073,  -0.014 - 0.023 - 0.018 - 0.146],
   [-0.017 - 0.008 - 0.010 - 0.046,  -0.008 - 0.012 - 0.010 - 0.092]]
= [[-0.135, -0.202],
   [-0.081, -0.123]]
```

"cat" contribution to ∂L/∂Wx (t=1 row above): [[-0.028, -0.014], [-0.017, -0.008]]
"mat" contribution to ∂L/∂Wx (t=4 row above): [[-0.073, -0.146], [-0.046, -0.092]]

"mat" drives weight updates roughly 3-11× more than "cat". The optimizer barely learns that "cat" matters.
...
```
t=1: [-0.028, -0.017]ᵀ ⊗ h₀=[0,0]: [[0,0],[0,0]]   (h₀ is zeros)
t=2: [-0.078, -0.040]ᵀ ⊗ [0.537, 0.380]: [[-0.042, -0.030], [-0.021, -0.015]]
t=3: [-0.180, -0.099]ᵀ ⊗ [0.391, 0.398]: [[-0.070, -0.072], [-0.039, -0.039]]
t=4: [-0.366, -0.231]ᵀ ⊗ [0.260, 0.261]: [[-0.095, -0.096], [-0.060, -0.060]]
...
Wh_new = Wh - lr × ∂L/∂Wh
= [[0.4, 0.1], - 0.1 × [[-0.207, -0.198],
   [0.2, 0.3]]            [-0.120, -0.114]]
= [[0.421, 0.120],
   [0.212, 0.311]]

Wy_new = Wy - lr × ∂L/∂Wy
= [0.6, 0.4] - 0.1 × [-0.202, -0.250]
= [0.620, 0.425]
```

All weights shift slightly upward. Why? The model predicted 0.329 but needed 1.0. Larger weights → larger hidden states → larger ŷ → closer to 1.0.

---

## 5. Second Forward Pass (Verify Loss Decreased)

Using updated weights: Wx=[[0.514,0.220],[0.108,0.612]], Wh=[[0.421,0.120],[0.212,0.311]], Wy=[0.620,0.425]:

```
t=1 (x₁=[1.00, 0.50]):
  Wx·x₁: [0.514×1.00 + 0.220×0.50,  0.108×1.00 + 0.612×0.50] = [0.624, 0.414]
  h₁ = tanh([0.624, 0.414]) = [0.554, 0.392]

t=2 (x₂=[0.20, 0.30]):
  Wx·x₂: [0.169, 0.205]
  Wh·h₁: [0.421×0.554 + 0.120×0.392,  0.212×0.554 + 0.311×0.392] = [0.280, 0.240]  (approx)
  a₂ = [0.449, 0.445]
  h₂ = tanh([0.449, 0.445]) = [0.421, 0.418]

t=3 (x₃=[0.10, 0.10]):
  Wx·x₃: [0.073, 0.072]
  Wh·h₂: [0.421×0.421 + 0.120×0.418,  0.212×0.421 + 0.311×0.418] = [0.227, 0.219]
  a₃ = [0.300, 0.291]
  h₃ = tanh([0.300, 0.291]) = [0.291, 0.283]

t=4 (x₄=[0.20, 0.40]):
  Wx·x₄: [0.191, 0.266]
  Wh·h₃: [0.421×0.291 + 0.120×0.283,  0.212×0.291 + 0.311×0.283] = [0.156, 0.150]
  a₄ = [0.347, 0.416]
  h₄ = tanh([0.347, 0.416]) = [0.334, 0.394]

ŷ' = Wy · h₄ = 0.620×0.334 + 0.425×0.394 = 0.207 + 0.167 = 0.374

Before update:  L = 0.225,  ŷ = 0.329
After update:   L = 0.196,  ŷ = 0.374   ← closer to y=1.0 ✓

L' = ½(1.0 - 0.374)² = ½ × 0.626² = ½ × 0.392 = 0.196
```

One gradient step: loss decreased by 13%.

The fundamental problem remains though: "cat" contributes [[-0.028,-0.014],[-0.017,-0.008]] to ∂L/∂Wx. "mat" contributes [[-0.073,-0.146],[-0.046,-0.092]] to ∂L/∂Wx. The model is learning from "mat" roughly 3-11× harder than from "cat".
...
"cat"           "sat"          "on"           "mat"
  ↓               ↓              ↓               ↓
 [h₁]  ────────→ [h₂]  ───────→ [h₃]  ───────→ [h₄] + Wy → ŷ=0.329
[0.537,        [0.391,        [0.260,        [0.301,
 0.380]         0.398]         0.261]         0.372]

dim 0 trace: 0.537 → 0.391 → 0.260 → 0.301
             (cat)   -27%    -33%    (barely there)

BACKWARD PASS — gradients flow left ←

δ₄=[-0.403,-0.268],  δ₃=[-0.193,-0.106],  δ₂=[-0.092,-0.048],  δ₁=[-0.039,-0.020]

|δ₁|=0.044   |δ₂|=0.103   |δ₃|=0.220   |δ₄|=0.484
  9%           21%           45%          100%
...
# t=1 a=[0.6   0.4  ] h=[0.537 0.380]
# t=2 a=[0.413 0.421] h=[0.391 0.398]
# t=3 a=[0.266 0.268] h=[0.260 0.261]
# t=4 a=[0.310 0.390] h=[0.301 0.372]

hN     = h
y_hat  = Wy @ hN
loss   = 0.5 * (y - y_hat) ** 2
print(f"# ŷ = {y_hat:.3f}  L = {loss:.3f}")   # ŷ = 0.329  L = 0.225
...
# t=4: δ=[-0.193 -0.106]  |δ|=0.220
# t=3: δ=[-0.092 -0.048]  |δ|=0.103
# t=2: δ=[-0.039 -0.020]  |δ|=0.044
# t=1: δ=[-0.015 -0.008]  |δ|=0.017
...
# ∂L/∂Wx = [[-0.135 -0.202] [-0.081 -0.123]]   ← matches hand computation ✓
# ∂L/∂Wh = [[-0.207 -0.198] [-0.120 -0.114]]   ✓
